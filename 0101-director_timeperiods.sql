...
INSERT INTO `icinga_timeperiod` (`id`, `object_name`, `display_name`, `update_method`, `zone_id`, `object_type`, `disabled`, `prefer_includes`) VALUES
...
INSERT INTO `icinga_timeperiod_range` (`timeperiod_id`, `range_key`, `range_value`, `range_type`, `merge_behaviour`) VALUES
...
INSERT INTO `icinga_timeperiod_include` (`timeperiod_id`, `include_id`) VALUES
(3, 4);
UNLOCK TABLES;
