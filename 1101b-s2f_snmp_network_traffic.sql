...
INSERT IGNORE icinga_service_field (service_id, datafield_id, is_required) VALUES ((select id from icinga_service where object_name = "generic_snmp_interfaces"),(select id from director_datafield where varname = "snmp_timeout"),'n');
